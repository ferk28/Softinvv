...
<html lang="en">
    ...
    <body>
        ...
        <br>
        <p class="text-left"><small>Empleado: <u><strong>{{$safeguard->employee->name_employee}}</strong></u></small></p>
        ...
        <p class="text-justify"><small>Para casos de pérdida del equipo o daño, el departamento de TI evaluara y dictaminara la correspondiente al mismo.</small></p>
        ...
        <table style="width: 99%">
            <tbody>
                ...
                <tr class="well" style="padding: 1%">
                    <th style="padding: 1%" class="text-center"> <small>{{$safeguard->employee->name_employee}}</small></th>
                    <td style="padding: 1%" class="text-center"> <small>{{$safeguard->employee->boss->name_boss}}</small> </td>
                </tr>
            </tbody>
        </table>
